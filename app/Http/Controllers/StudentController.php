...
class StudentController extends Controller
{
    ...
    public function dashboard(Request $request)
    {
        ...
        return Inertia::render('student/StudentDashboard', $data);
    }
    ...
    public function getSubjects(Request $request)
    {
        ...
        return Inertia::render('student/StudentSubjects', ['subjects' => $subjects]);
    }
    ...
    /**
     * Get student results as JSON API (for AJAX requests)
     */
    ...
    /**
     * Get student progress (for student access)
     */
    public function getProgress(Request $request)
    {
        ...
        return Inertia::render('student/StudentProgress', [
            'student' => $student->load(['schoolClass', 'studentSubjects.subject']),
            'results' => $resultsBySession,
            'current_session' => $currentSession,
            'admission_session' => $student->admissionAcademicSession,
    ...
    public function changePassword(Request $request)
    {
        ...
        try {
            ...
            if ($request->expectsJson() || $request->wantsJson() || $request->is('api/*') || str_contains($request->path(), '/student/')) {
                return response()->json([
