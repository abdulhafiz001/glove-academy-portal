...
class ClassController extends Controller
{
     ...
     * Returns JSON for API requests, Inertia for page requests
     */
    public function index(Request $request)
    {
        ...
        $result = \App\Helpers\CacheHelper::getClasses(function () use ($user, $cacheKey) {
            if ($user->isAdmin()) {
                ...
                // Regular teachers cannot access classes
        ...
        if ($result['message'] === 'Access denied') {
            ...
            abort(403, 'Access denied. Only admins and form teachers can view classes.');
        }
